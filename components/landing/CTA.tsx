...
export default function CTA({
  ...
  return (
    <>
      <Container className="mt-20 rounded-md border border-dashed border-black/20 bg-background/80 backdrop-blur-md py-8 dark:border-white/10">
        <div className="mt-6 w-full flex-col px-6 pb-8 sm:flex sm:items-center sm:justify-between sm:px-12">
          ...
          <div className="mt-4 flex w-full justify-center sm:mt-0 sm:w-auto sm:justify-end">
            ...
            >
              <div className="relative px-4 py-2 z-20 flex items-center gap-2 transition-all duration-300 group-hover:gap-16">
                ...
                <div className="absolute left-12 flex -translate-x-full transform items-center gap-0 opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  <svg
                  ...
                  <div className="mr-4 ml-2 flex h-5 w-5 items-center justify-center rounded-full bg-black/10 text-[8px] dark:bg-white/10">
                    You
                  </div>
                </div>
